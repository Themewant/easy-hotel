 ...
 *
 */
if ( ! class_exists( 'ESHB_Customize_Panel_CSF' ) && class_exists( 'WP_Customize_Panel' ) ) {
  class ESHB_Customize_Panel_CSF extends WP_Customize_Panel {
    public $type = 'easy-hotel';
  }
}
 ...
 *
 */
if ( ! class_exists( 'ESHB_Customize_Section_CSF' ) && class_exists( 'WP_Customize_Section' ) ) {
  class ESHB_Customize_Section_CSF extends WP_Customize_Section {
    public $type = 'easy-hotel';
  }
}
 ...
 *
 */
if ( ! class_exists( 'ESHB_Customize_Control_CSF' ) && class_exists( 'WP_Customize_Control' ) ) {
  class ESHB_Customize_Control_CSF extends WP_Customize_Control {
    ...
    public function render_field_content() {
      ...
      $complex = apply_filters( 'eshb_customize_complex_fields', array(
        'accordion',
        'background',
        'border',
        'button_set',
      ...
      ESHB::field( $this->field, $this->value(), $this->unique, 'customize' );
