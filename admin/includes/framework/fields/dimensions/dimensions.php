 ...
 *
 */
if ( ! class_exists( 'ESHB_Field_dimensions' ) ) {
  class ESHB_Field_dimensions extends ESHB_Fields {
    ...
    public function render() {
      ...
      $args = wp_parse_args( $this->field, array(
        ...
        'width_placeholder'  => esc_html__( 'width', 'easy-hotel' ),
        'height_placeholder' => esc_html__( 'height', 'easy-hotel' ),
        'width'              => true,
        'height'             => true,
        'unit'               => true,
        'show_units'         => true,
