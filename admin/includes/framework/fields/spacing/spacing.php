 ...
 *
 */
if ( ! class_exists( 'ESHB_Field_spacing' ) ) {
  class ESHB_Field_spacing extends ESHB_Fields {
    ...
    public function render() {
      ...
      if ( ! empty( $args['all'] ) ) {
        ...
        echo '<input type="number" name="'. esc_attr( $this->field_name( '[all]' ) ) .'" value="'. esc_attr( $value['all'] ) .'"'. esc_attr($placeholder) .' class="csf-input-number'. esc_attr( $is_unit ) .'" step="any" />';
        ...
        foreach ( $properties as $property ) {
          ...
          echo '<input type="number" name="'. esc_attr( $this->field_name( '['. $property .']' ) ) .'" value="'. esc_attr( $value[$property] ) .'"'. esc_attr($placeholder) .' class="csf-input-number'. esc_attr( $is_unit ) .'" step="any" />';
          echo ( $unit ) ? '<span class="csf--label csf--unit">'. esc_attr( $args['units'][0] ) .'</span>' : '';
          echo '</div>';
