 ...
 *
 */
if ( ! class_exists( 'ESHB_Field_sorter' ) ) {
  class ESHB_Field_sorter extends ESHB_Fields {
    ...
    public function render() {
      ...
      $args = wp_parse_args( $this->field, array(
        'disabled'       => true,
        'enabled_title'  => esc_html__( 'Enabled', 'easy-hotel' ),
        'disabled_title' => esc_html__( 'Disabled', 'easy-hotel' ),
      ) );
