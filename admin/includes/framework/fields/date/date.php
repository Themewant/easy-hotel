 ...
 *
 */
if ( ! class_exists( 'ESHB_Field_date' ) ) {
  class ESHB_Field_date extends ESHB_Fields {
    ...
    public function render() {
      ...
      echo '<div class="csf-date-settings" data-settings="'. esc_attr( wp_json_encode( $settings ) ) .'"></div>';
