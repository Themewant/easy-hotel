 ...
 *
 */
if ( ! class_exists( 'ESHB_Field_group' ) ) {
  class ESHB_Field_group extends ESHB_Fields {
    ...
    public function render() {
      ...
      $args = wp_parse_args( $this->field, array(
        ...
        'min'                       => 0,
        'fields'                    => array(),
        'button_title'              => esc_html__( 'Add New', 'easy-hotel' ),
      ...
      if ( preg_match( '/'. preg_quote( '['. $this->field['id'] .']' ) .'/', $this->unique ) ) {
        ...
        echo '<div class="csf-notice csf-notice-danger">'. esc_html__( 'Error: Field ID conflict.', 'easy-hotel' ) .'</div>';
        ...
        echo '<div class="csf-cloneable-item csf-cloneable-hidden" data-depend-id="'. esc_attr( $this->field['id'] ) .'">';
          ...
          echo '<i class="csf-cloneable-remove csf-confirm fas fa-times" data-confirm="'. esc_html__( 'Are you sure to delete this item?', 'easy-hotel' ) .'"></i>';
          echo '</div>';
          ...
          foreach ( $this->field['fields'] as $field ) {
            ...
            ESHB::field( $field, $field_default, '___'. $field_unique, 'field/group' );
        ...
        echo '<div class="csf-cloneable-wrapper csf-data-wrapper" data-title-by="'. esc_attr( wp_json_encode( $title_by ) ) .'" data-title-by-prefix="'. esc_attr( $title_by_prefix ) .'" data-title-number="'. esc_attr( $title_number ) .'" data-field-id="['. esc_attr( $this->field['id'] ) .']" data-max="'. esc_attr( $args['max'] ) .'" data-min="'. esc_attr( $args['min'] ) .'">';
          ...
          foreach ( $this->value as $value ) {
            ...
            echo '<div class="csf-cloneable-item">';
              ...
              foreach ( $this->field['fields'] as $field ) {
                ...
                ESHB::field( $field, $field_value, $field_unique, 'field/group' );
        ...
        echo '<div class="csf-cloneable-alert csf-cloneable-max">'. esc_html__( 'You cannot add more.', 'easy-hotel' ) .'</div>';
        echo '<div class="csf-cloneable-alert csf-cloneable-min">'. esc_html__( 'You cannot remove more.', 'easy-hotel' ) .'</div>';
        echo '<a href="#" class="button button-primary csf-cloneable-add">'. esc_html($args['button_title']) .'</a>';
