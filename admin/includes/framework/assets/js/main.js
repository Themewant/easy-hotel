...
;(function( $, window, document, undefined ) {
  ...
  // Expand All Options
  //
  $.fn.eshb_expand_all = function() {
    return this.each( function() {
      $(this).on('click', function( e ) {

        e.preventDefault();
        $('.csf-wrapper').toggleClass('csf-show-all');
        $('.csf-section').eshb_reload_script();
  ...
  //
  $.fn.eshb_page_templates = function() {
    if ( this.length ) {
        ...
        if ( value.length > 3 ) {
          ...
          $titles.each( function() {
            ...
            if ( $title.text().match( new RegExp('.*?' + value + '.*?', 'i') ) ) {
              ...
              $field.parent().eshb_reload_script();
  ...
  $.fn.eshb_dependency = function() {
    return this.each( function() {
      ...
      if( $fields.length ) {
        ...
        var normal_ruleset = $.eshb_deps.createRuleset(),
            global_ruleset = $.eshb_deps.createRuleset(),
            normal_depends = [],
            global_depends = [];
        ...
        if ( normal_depends.length ) {
          $.eshb_deps.enable($this, normal_ruleset, normal_depends);
        }

        if ( global_depends.length ) {
          $.eshb_deps.enable(CSF.vars.$body, global_ruleset, global_depends);
        }
  ...
  // Field: accordion
  //
  $.fn.eshb_field_accordion = function() {
    return this.each( function() {
    ...
    return this.each( function() {
      ...
      base.notificationOverlay = function() {
        ...
        if ( wp.customize.notifications && wp.customize.OverlayNotification ) {
          ...
          wp.customize.notifications.add( new wp.customize.OverlayNotification('eshb_field_backup_notification', {
            type: 'default',
            message: '&nbsp;',
            loading: true
          }));
      ...
      $reset.on('click', function( e ) {
        ...
        if ( CSF.vars.is_confirm ) {
          ...
          .fail( function( response ) {
            ...
            wp.customize.notifications.remove('eshb_field_backup_notification');
          });
  ...
  // Field: background
  //
  $.fn.eshb_field_background = function() {
    return this.each( function() {
      $(this).find('.csf--background-image').eshb_reload_script();
    });
  };
  ...
  // Field: code_editor
  //
  $.fn.eshb_field_code_editor = function() {
    return this.each( function() {
  ...
  // Field: datetime
  //
  $.fn.eshb_field_datetime = function() {
    return this.each( function() {
  ...
  // Field: fieldset
  //
  $.fn.eshb_field_fieldset = function() {
    return this.each( function() {
      $(this).find('.csf-fieldset-content').eshb_reload_script();
    });
  };
  ...
  // Field: gallery
  //
  $.fn.eshb_field_gallery = function() {
    return this.each( function() {
    ...
    return this.each( function() {
      ...
      $wrapper.accordion({
        ...
        activate: function( event, ui ) {
          ...
          if ( $panel.length && !$panel.data( 'opened' ) ) {
            ...
            $panel.eshb_reload_script();
            $panel.data( 'opened', true );
            $panel.data( 'retry', false );

          } else if ( $panel.data( 'retry' ) ) {

            $panel.eshb_reload_script_retry();
            $panel.data( 'retry', false );
      ...
      $wrapper.sortable({
        ...
        update: function( event, ui ) {
          ...
          $wrapper.eshb_customizer_refresh();
      ...
      $group.children('.csf-cloneable-add').on('click', function( e ) {
        ...
        var $cloned_item = $hidden.eshb_clone(true);
        ...
        $wrapper.eshb_customizer_refresh();
        $wrapper.eshb_customizer_listen({closest: true});
      ...
      var event_clone = function( e ) {
        ...
        var $this           = $(this),
            ...
            $cloned_helper  = $parent.children('.csf-cloneable-helper').eshb_clone(true),
            $cloned_title   = $parent.children('.csf-cloneable-title').eshb_clone(),
            $cloned_content = $parent.children('.csf-cloneable-content').eshb_clone(),
  ...
  // Field: repeater
  //
  $.fn.eshb_field_repeater = function() {
    return this.each( function() {
      ...
      $wrapper.sortable({
        ...
        update: function( event, ui ) {
          ...
          $wrapper.eshb_customizer_refresh();
          ui.item.eshb_reload_script_retry();
      ...
      $repeater.children('.csf-repeater-add').on('click', function( e ) {
        ...
        $wrapper.append($cloned_item);
        $cloned_item.children('.csf-repeater-content').eshb_reload_script();
        $wrapper.eshb_customizer_refresh();
        $wrapper.eshb_customizer_listen({closest: true});
      ...
      var event_clone = function( e ) {
        ...
        var $this           = $(this),
            ...
            $cloned_content = $parent.children('.csf-repeater-content').eshb_clone(),
            $cloned_helper  = $parent.children('.csf-repeater-helper').eshb_clone(true),
  ...
  // Field: sortable
  //
  $.fn.eshb_field_sortable = function() {
    return this.each( function() {
      ...
      $sortable.sortable({
        ...
        placeholder: 'widget-placeholder',
        update: function( event, ui ) {
          $sortable.eshb_customizer_refresh();
        }
      });

      $sortable.find('.csf-sortable-content').eshb_reload_script();
  ...
  // Field: spinner
  //
  $.fn.eshb_field_spinner = function() {
    return this.each( function() {
  ...
  // Field: switcher
  //
  $.fn.eshb_field_switcher = function() {
    return this.each( function() {
  ...
  $.fn.eshb_field_tabbed = function() {
    return this.each( function() {
      ...
      $contents.eq(0).eshb_reload_script();
  ...
  // Field: typography
  //
  $.fn.eshb_field_typography = function() {
    return this.each(function () {

      var base          = this;
      var $this         = $(this);
      var loaded_fonts  = [];
      var webfonts      = eshb_typography_json.webfonts;
      var googlestyles  = eshb_typography_json.googlestyles;
      var defaultstyles = eshb_typography_json.defaultstyles;
  ...
  // Field: wp_editor
  //
  $.fn.eshb_field_wp_editor = function() {
    return this.each( function() {

      if ( typeof window.wp.editor === 'undefined' || typeof window.tinyMCEPreInit === 'undefined' || typeof window.tinyMCEPreInit.mceInit.eshb_wp_editor === 'undefined' ) {
        return;
      }
      ...
      var default_editor_settings = {
        tinymce: window.tinyMCEPreInit.mceInit.eshb_wp_editor,
        quicktags: window.tinyMCEPreInit.qtInit.eshb_wp_editor
      };
      ...
      // Add Media buttons
      if ( field_editor_settings.media_buttons && window.eshb_media_buttons ) {
        ...
        if ( $editor_buttons.length ) {
          ...
          var $media_buttons = $(window.eshb_media_buttons);
  ...
  // Confirm
  //
  $.fn.eshb_confirm = function() {
    return this.each( function() {
      $(this).on('click', function( e ) {

        var confirm_text   = $(this).data('confirm') || window.eshb_vars.i18n.confirm;
      ...
      $this.on('click', function( e ) {
        ...
        if ( !flooding ) {
          ...
          if ( $this.hasClass('csf-save-ajax') ) {
            ...
            window.wp.ajax.post( 'eshb_'+ $panel.data('unique') +'_ajax_save', {
    ...
    return this.each( function() {
      ...
      if ( $form.attr('id') === 'addtag' ) {
        ...
        var $submit = $form.find('#submit'),
            $cloned = $this.children('.csf-field').eshb_clone();
        ...
        $submit.on( 'click', function() {
          ...
          if ( !$form.find('.form-required').hasClass('form-invalid') ) {
            ...
            $cloned = $cloned.eshb_clone();

            $this.eshb_reload_script();
    ...
    return this.each( function() {
      ...
      $select.on( 'change', function() {
        ...
        if ( sc_key ) {
          ...
          .done( function( response ) {
            ...
            $cloned = $appended.find('.csf--repeat-shortcode').eshb_clone();

            $appended.eshb_reload_script();
            $appended.find('.csf-fields').eshb_reload_script();
      ...
      $insert.on('click', function( e ) {
        ...
        if ( gutenberg_id ) {
          ...
          var content = window.eshb_gutenberg_props.attributes.hasOwnProperty('shortcode') ? window.eshb_gutenberg_props.attributes.shortcode : '';
          window.eshb_gutenberg_props.setAttributes({shortcode: content + shortcode});
      ...
      $modal.on('click', '.csf--repeat-button', function( e ) {
        ...
        var $new_clone  = $cloned.eshb_clone();
        var $remove_btn = $new_clone.find('.csf-repeat-remove');

        var $appended = $new_clone.appendTo( $repeatable );

        $new_clone.find('.csf-fields').eshb_reload_script();
  ...
  $.fn.eshb_color = function() {
    return this.each( function() {

      var $input        = $(this),
          picker_color  = CSF.funcs.parse_color( $input.val() ),
          palette_color = window.eshb_vars.color_palette.length ? window.eshb_vars.color_palette : true,
          $container;
    ...
    return this.each( function() {
      ...
      var $this       = $(this),
          ...
          set_options = $.extend({
            ...
            width: set_width,
            no_results_text: window.eshb_vars.i18n.no_results_text,
      ...
      if ( is_ajax ) {
        ...
        var set_ajax_options = $.extend({
          ...
          min_length: 3,
          type_delay: 500,
          typing_text: window.eshb_vars.i18n.typing_text,
          searching_text: window.eshb_vars.i18n.searching_text,
          no_results_text: window.eshb_vars.i18n.no_results_text,
        }, $this.data('chosen-settings'));
  ...
  // Customize Refresh
  //
  $.fn.eshb_customizer_refresh = function() {
    return this.each( function() {
  ...
  //
  $.fn.eshb_customizer_listen = function( options ) {
  ...
  $(document).on('expanded', '.control-section', function() {
    ...
    if ( $this.hasClass('open') && !$this.data('inited') ) {
      ...
      if ( $fields.length ) {
        $this.eshb_dependency();
        $fields.eshb_reload_script({dependency: false});
        $complex.eshb_customizer_listen();
      }
  ...
  $.fn.eshb_widgets = function() {
    return this.each( function() {
      ...
      $('.widgets-sortables, .control-section-sidebar').on('sortstop', function( event, ui ) {
        ui.item.find('.csf-fields').eshb_reload_script_retry();
      });
  ...
  //
  $.fn.eshb_nav_menu = function() {
    return this.each( function() {

      var $navmenu = $(this);

      $navmenu.on('click', 'a.item-edit', function() {
        $(this).closest('li.menu-item').find('.csf-fields').eshb_reload_script();
      });
  ...
  // Retry Plugins
  //
  $.fn.eshb_reload_script_retry = function() {
    return this.each( function() {

      var $this = $(this);

      if ( $this.data('inited') ) {
        $this.children('.csf-field-wp_editor').eshb_field_wp_editor();
      }
  ...
  // Reload Plugins
  //
  $.fn.eshb_reload_script = function( options ) {
    ...
    return this.each( function() {
      ...
      if ( !$this.data('inited') ) {
        ...
        // Field plugins
        $this.children('.csf-field-accordion').eshb_field_accordion();
        $this.children('.csf-field-backup').eshb_field_backup();
        $this.children('.csf-field-background').eshb_field_background();
        $this.children('.csf-field-code_editor').eshb_field_code_editor();
        $this.children('.csf-field-date').eshb_field_date();
        $this.children('.csf-field-datetime').eshb_field_datetime();
        $this.children('.csf-field-fieldset').eshb_field_fieldset();
        $this.children('.csf-field-gallery').eshb_field_gallery();
        $this.children('.csf-field-group').eshb_field_group();
        $this.children('.csf-field-icon').eshb_field_icon();
        $this.children('.csf-field-link').eshb_field_link();
        $this.children('.csf-field-media').eshb_field_media();
        $this.children('.csf-field-map').eshb_field_map();
        $this.children('.csf-field-repeater').eshb_field_repeater();
        $this.children('.csf-field-slider').eshb_field_slider();
        $this.children('.csf-field-sortable').eshb_field_sortable();
        $this.children('.csf-field-sorter').eshb_field_sorter();
        $this.children('.csf-field-spinner').eshb_field_spinner();
        $this.children('.csf-field-switcher').eshb_field_switcher();
        $this.children('.csf-field-tabbed').eshb_field_tabbed();
        $this.children('.csf-field-typography').eshb_field_typography();
        $this.children('.csf-field-upload').eshb_field_upload();
        $this.children('.csf-field-wp_editor').eshb_field_wp_editor();

        // Field colors
        $this.children('.csf-field-border').find('.csf-color').eshb_color();
        $this.children('.csf-field-background').find('.csf-color').eshb_color();
        $this.children('.csf-field-color').find('.csf-color').eshb_color();
        $this.children('.csf-field-color_group').find('.csf-color').eshb_color();
        $this.children('.csf-field-link_color').find('.csf-color').eshb_color();
        ...
        $this.children('.csf-field-checkbox').find('.csf-checkbox-all').eshb_checkbox_all();

        // Field Siblings
        $this.children('.csf-field-button_set').find('.csf-siblings').eshb_siblings();
        $this.children('.csf-field-image_select').find('.csf-siblings').eshb_siblings();
        $this.children('.csf-field-palette').find('.csf-siblings').eshb_siblings();

        // Help Tooptip
        $this.children('.csf-field').find('.csf-help').eshb_help();
  ...
  $(document).ready( function() {
    ...
    $('.csf-save').eshb_save();
    $('.csf-options').eshb_options();
    $('.csf-sticky-header').eshb_sticky();
    $('.csf-nav-options').eshb_nav_options();
    $('.csf-nav-metabox').eshb_nav_metabox();
    $('.csf-taxonomy').eshb_taxonomy();
    $('.csf-page-templates').eshb_page_templates();
    $('.csf-post-formats').eshb_post_formats();
    $('.csf-shortcode').eshb_shortcode();
    $('.csf-search').eshb_search();
    $('.csf-confirm').eshb_confirm();
    $('.csf-expand-all').eshb_expand_all();
    $('.csf-onload').eshb_reload_script();
    $('#widgets-editor').eshb_widgets();
    $('#widgets-right').eshb_widgets();
    $('#menu-to-edit').eshb_nav_menu();
