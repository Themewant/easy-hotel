...
<div class="eshb-welcome-cols">
  ...
  <div class="csf--col csf--col-first">
    <span class="csf--icon csf--<?php echo esc_attr( ESHB::$premium ? 'active' : 'deactive' ); ?>"><i class="fas fa-<?php echo esc_attr( ESHB::$premium ? 'check' : 'times' ); ?>"></i></span>
...
<pre>
add_filter( 'eshb_welcome_page', '__return_false' );
</pre>
</div>
<?php } ?>
