 ...
 *
 */
if ( ! class_exists( 'ESHB_Abstract' ) ) {
#[AllowDynamicProperties]
abstract class ESHB_Abstract {
  ...
  public function __construct() {
    ...
    if ( ! empty( $this->args['output_css'] ) || ! empty( $this->args['enqueue_webfont'] ) ) {
      ...
      ESHB::$css = apply_filters( "eshb_{$this->unique}_output_css", ESHB::$css, $this );
    }
  ...
  public function recursive_output_css( $fields = array(), $combine_field = array() ) {
    ...
    if ( ! empty( $fields ) ) {
      ...
      foreach ( $fields as $field ) {
        ...
        $field_class  = 'ESHB_Field_' . $field_type;
