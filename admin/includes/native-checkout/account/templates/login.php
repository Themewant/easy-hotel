...
$eshb_redirect = $account->get_account_url();
?>
    ...
    <div class="eshb-container eshb-account-login-box">
        <div class="eshb-card">
            ...
            <p class="eshb-account-login-links">
                <a href="<?php echo esc_url( wp_lostpassword_url( $eshb_redirect ) ); ?>"><?php esc_html_e( 'Lost your password?', 'easy-hotel' ); ?></a>
