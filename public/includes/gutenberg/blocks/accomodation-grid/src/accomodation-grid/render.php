...
<div class="eshb-accomodation-grid-block-wrap room-grid-wrap">
    <div class="room-grid eshb-item-grid <?php echo esc_attr($grid_style); ?>" style="<?php echo esc_attr( $style_attr ); ?>">
            ...
            while($grid_query->have_posts()): $grid_query->the_post();
                ...
                include ESHB_PL_PATH . 'public/includes/gutenberg/blocks/accomodation-grid/src/accomodation-grid/grid-styles/' . $grid_style .".php";  
    ...
    <?php
    if($show_pagination){
        echo esc_html($hotel_view->eshb_get_pagination($grid_query));
    }
    ?>
</div>
