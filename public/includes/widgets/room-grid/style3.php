...
?>
<div class="grid-item relative eshb-text-center wow fadeInUp animated" data-wow-delay="<?php echo esc_attr( $animation_delay )?>s">
    ...
    <div class="p-3 pb-1 w-100 eshb-text-center">
        ...
        <div class="eshb-text-center mb-3">
            <?php 
                ...
                ?>
                    <span class="mx-2 capacity"><?php echo wp_kses_post($price); ?><div class="label"> / <?php echo esc_html( eshb_get_translated_string($perodicity_string) );?></div></span>
                <?php 
                    } 
                ?>
    ...
    <a class="details-btn rts-btn btn-main w-100" href="<?php echo esc_url( $booking_url ); ?>"><?php echo esc_html( $btn_text )?></a>
</div>