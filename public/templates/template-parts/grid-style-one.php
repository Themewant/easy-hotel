...
<?php
    ...
    if ($query->have_posts()) {
        ...
        while ($query->have_posts()) {
            ...
            $total_capacity = $metaboxes['total_capacity'];
            $accomodation_info_group = $metaboxes['accomodation_info_group'];
                ...
                <div class="item-inner">
                    ...
                    <div class="pricing-info">
                        ...
                        ?>
                            ...
                            <h3 class="price"><?php echo wp_kses_post($price); ?><div class="label"> / <?php echo esc_html( eshb_get_translated_string($perodicity_string) );?></div></h3>
                        <?php 
                            } 
                        ?>
        ...
        echo esc_html($view->eshb_get_pagination($query));
